        ...
        <div className="row g-5">
          <div className="col-lg-4">
            <div className="post-entry-1 lg">
              <a href="single-post.html"><img src="assert/img/IMG_0945.JPG" alt="" className="img-fluid"/></a>
              <div className="post-meta"><span className="date">Lifestyle</span> <span className="mx-1"></span> <span>Jul 5th 22</span></div>
              <h2><a href="single-post.html">Sweat, determination, and the iron will to rise stronger. 💪 #GymBoyGrit</a></h2>
            ...
            <div className="row g-5">
              <div className="col-lg-4 border-start custom-border">
                ...
                <div className="post-entry-1">
                  ...
                  <div className="post-meta"><span className="date">Lifestyle</span> <span className="mx-1"></span> <span>Jul 17th 22</span></div>
                  <h2><a href="single-post.html">Sweat, determination, and iron will define the journey of a gym goer.</a></h2>
                </div>
                <div className="post-entry-1">
                  <a href="single-post.html"><img src="assert/img/26259.jpg" alt="" className="img-fluid"/></a>
                  <div className="post-meta"><span className="date">Lifestyle</span> <span className="mx-1"></span> <span>Mar 15th 22</span></div>
                  <h2><a href="single-post.html">Muscles forged in dedication, strength defined by commitment. 💥 #GymBoyJourney</a></h2>
                </div>
              </div>
              <div className="col-lg-4 border-start custom-border">
                <div className="post-entry-1">
                  <a href="single-post.html"><img src="assert/img/26279.jpg" alt="" className="img-fluid"/></a>
                  <div className="post-meta"><span className="date">Lifestyle</span> <span className="mx-1"></span> <span>Jul 5th 22</span></div>
                  <h2><a href="single-post.html">Fuelled by passion, sculpting dreams into reality, one workout at a time. 💫 #GymBoyChronicles</a></h2>
                </div>
                <div className="post-entry-1">
